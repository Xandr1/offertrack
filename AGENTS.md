...
- Keep pnpm lockfiles generated by repository-pinned pnpm version
- Preserve blocking OSV and container vulnerability scanning
- pnpm 12 lockfile splitting for OSV is required until the scanner supports the multi-document format directly
...
For infrastructure changes, run the existing Terraform and staging contract checks and preserve immutable-image, IAM, secret, networking, and rollback contracts.
