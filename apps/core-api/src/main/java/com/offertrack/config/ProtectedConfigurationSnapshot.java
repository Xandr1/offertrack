...
public record ProtectedConfigurationSnapshot(
    ...
    String redisTimeout,
    String redisTlsEnabled,
    String redisTlsBundle,
    String redisTlsCaCertificates,
    String smtpHost,
    String smtpPort,
    String smtpUsername,
    String smtpPassword,
    String smtpStarttlsEnabled,
    String smtpStarttlsRequired,
  ...
  public static ProtectedConfigurationSnapshot from(Environment environment) {
    return new ProtectedConfigurationSnapshot(
        ...
        environment.getProperty("spring.data.redis.ssl.bundle"),
        environment.getProperty("spring.ssl.bundle.pem.offertrack-redis.truststore.certificate"),
        ...
        environment.getProperty("spring.mail.properties.mail.smtp.connectiontimeout"),
        environment.getProperty("spring.mail.properties.mail.smtp.timeout"),
        environment.getProperty("spring.mail.properties.mail.smtp.writetimeout"),
        ...
        environment.getProperty("app.management.dependency-health-key"),
